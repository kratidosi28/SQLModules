...
-- Step 3 Execute the Marketing.GetProductsByColor stored procedure for color blue
EXEC Marketing.GetProductsByColor 'Blue';
GO

-- Step 4 Execute the Marketing.GetProductsByColor stored procedure with no color
